...
template void pre_process::process_txn<zera_txn::ProposalCancelTXN>(zera_txn::ProposalCancelTXN *txn, const zera_txn::TRANSACTION_TYPE &txn_type, const std::string &client_ip);
